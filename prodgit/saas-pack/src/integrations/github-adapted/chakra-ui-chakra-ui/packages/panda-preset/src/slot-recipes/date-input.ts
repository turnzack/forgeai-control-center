 ...
 * Original File: chakra-ui-main/packages/panda-preset/src/slot-recipes/date-input.ts
 * License: MIT
 * Adapted by: ForgeAI Studio Builder for saas-pack
 * Generated: 2026-09-24T00:34:56.645Z
 */
...
export const dateInputSlotRecipe = defineSlotRecipe({
  ...
  slots: ["root", "label", "control", "segmentGroup", "segment", "hiddenInput"],
  base: {
    root: {
      display: "flex",
