# PROJECT BRIEF — Bross Adventure

## 1. Nom du produit
**Bross Adventure**

## 2. Résumé
Aventure plateforme avec quêtes secondaires. Solution métier dans le domaine **Jeu Vidéo & Arcade**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
