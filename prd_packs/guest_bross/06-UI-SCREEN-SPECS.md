# UI SCREEN SPECIFICATIONS & AI GENERATION — Bross Adventure

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Jeu Vidéo & Arcade** dans Bross Adventure.
...
```text
# STITCH PROMPT — Bross Adventure

Contexte produit :
Bross Adventure - Aventure plateforme avec quêtes secondaires dans le domaine Jeu Vidéo & Arcade.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Bross Adventure.
