# UI SCREEN SPECIFICATIONS & AI GENERATION — Forge Universelle

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **SaaS Dashboard & Analytics** dans Forge Universelle.
...
```text
# STITCH PROMPT — Forge Universelle

Contexte produit :
Forge Universelle - Forge universelle de packs PRD dans le domaine SaaS Dashboard & Analytics.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Forge Universelle.
