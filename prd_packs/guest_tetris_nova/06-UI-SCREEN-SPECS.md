# UI SCREEN SPECIFICATIONS & AI GENERATION — Tetris Nova

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Jeu Vidéo & Arcade** dans Tetris Nova.
...
```text
# STITCH PROMPT — Tetris Nova

Contexte produit :
Tetris Nova - Tetris néon-futuriste avec combo system dans le domaine Jeu Vidéo & Arcade.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Tetris Nova.
