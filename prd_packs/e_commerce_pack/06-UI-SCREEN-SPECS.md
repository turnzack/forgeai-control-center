# UI SCREEN SPECIFICATIONS & AI GENERATION — ShopPro

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **E-commerce & Boutique en Ligne** dans ShopPro.
...
```text
# STITCH PROMPT — ShopPro

Contexte produit :
ShopPro - Boutique e-commerce multi-catégories dans le domaine E-commerce & Boutique en Ligne.
...
```text
Génère une illustration haute fidélité pour l'onboarding de ShopPro.
