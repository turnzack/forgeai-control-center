# PROJECT BRIEF — Marketing Hub

## 1. Nom du produit
**Marketing Hub**

## 2. Résumé
Hub marketing avec tracking UTM et lead scoring. Solution métier dans le domaine **Landing Page & Conversion**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
