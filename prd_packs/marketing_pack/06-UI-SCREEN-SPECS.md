# UI SCREEN SPECIFICATIONS & AI GENERATION — Marketing Hub

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Landing Page & Conversion** dans Marketing Hub.
...
```text
# STITCH PROMPT — Marketing Hub

Contexte produit :
Marketing Hub - Hub marketing avec tracking UTM et lead scoring dans le domaine Landing Page & Conversion.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Marketing Hub.
