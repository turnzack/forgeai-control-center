# UI SCREEN SPECIFICATIONS & AI GENERATION — Layout Bento

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Bibliothèque de Composants UI** dans Layout Bento.
...
```text
# STITCH PROMPT — Layout Bento

Contexte produit :
Layout Bento - Layout bento-grid type Apple Japan dans le domaine Bibliothèque de Composants UI.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Layout Bento.
