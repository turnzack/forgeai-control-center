# PROJECT BRIEF — Layout Bento

## 1. Nom du produit
**Layout Bento**

## 2. Résumé
Layout bento-grid type Apple Japan. Solution métier dans le domaine **Bibliothèque de Composants UI**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
