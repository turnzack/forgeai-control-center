# PROJECT BRIEF — Specs Studio

## 1. Nom du produit
**Specs Studio**

## 2. Résumé
Atelier de spécifications techniques détaillées. Solution métier dans le domaine **SaaS Dashboard & Analytics**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
