# UI SCREEN SPECIFICATIONS & AI GENERATION — Specs Studio

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **SaaS Dashboard & Analytics** dans Specs Studio.
...
```text
# STITCH PROMPT — Specs Studio

Contexte produit :
Specs Studio - Atelier de spécifications techniques détaillées dans le domaine SaaS Dashboard & Analytics.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Specs Studio.
