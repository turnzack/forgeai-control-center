# UI SCREEN SPECIFICATIONS & AI GENERATION — Catalogue Pro

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **E-commerce & Boutique en Ligne** dans Catalogue Pro.
...
```text
# STITCH PROMPT — Catalogue Pro

Contexte produit :
Catalogue Pro - Catalogue produits B2B avec fiches techniques dans le domaine E-commerce & Boutique en Ligne.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Catalogue Pro.
