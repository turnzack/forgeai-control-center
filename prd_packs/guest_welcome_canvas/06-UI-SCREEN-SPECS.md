# UI SCREEN SPECIFICATIONS & AI GENERATION — Welcome Canvas

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Landing Page & Conversion** dans Welcome Canvas.
...
```text
# STITCH PROMPT — Welcome Canvas

Contexte produit :
Welcome Canvas - Canvas d'accueil animé pour nouveaux visiteurs dans le domaine Landing Page & Conversion.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Welcome Canvas.
