# UI SCREEN SPECIFICATIONS & AI GENERATION — Workflow Orchestrator

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **SaaS Dashboard & Analytics** dans Workflow Orchestrator.
...
```text
# STITCH PROMPT — Workflow Orchestrator

Contexte produit :
Workflow Orchestrator - Orchestrateur de workflows temporisés dans le domaine SaaS Dashboard & Analytics.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Workflow Orchestrator.
