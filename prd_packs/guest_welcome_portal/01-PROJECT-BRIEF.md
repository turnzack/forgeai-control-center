# PROJECT BRIEF — Welcome Portal

## 1. Nom du produit
**Welcome Portal**

## 2. Résumé
Portail d'accueil multi-destinations. Solution métier dans le domaine **Landing Page & Conversion**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
