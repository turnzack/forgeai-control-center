# UI SCREEN SPECIFICATIONS & AI GENERATION — Welcome Portal

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Landing Page & Conversion** dans Welcome Portal.
...
```text
# STITCH PROMPT — Welcome Portal

Contexte produit :
Welcome Portal - Portail d'accueil multi-destinations dans le domaine Landing Page & Conversion.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Welcome Portal.
