# UI SCREEN SPECIFICATIONS & AI GENERATION — Mobile Shell

## 1. Spécification Écran SCR-001 : /onboarding
- **Route** : `/onboarding`
- **Objectif** : écran central pour l'expérience **Application Mobile & PWA** dans Mobile Shell.
...
```text
# STITCH PROMPT — Mobile Shell

Contexte produit :
Mobile Shell - Shell applicatif mobile réutilisable dans le domaine Application Mobile & PWA.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Mobile Shell.
