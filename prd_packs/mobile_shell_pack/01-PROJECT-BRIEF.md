# PROJECT BRIEF — Mobile Shell

## 1. Nom du produit
**Mobile Shell**

## 2. Résumé
Shell applicatif mobile réutilisable. Solution métier dans le domaine **Application Mobile & PWA**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
