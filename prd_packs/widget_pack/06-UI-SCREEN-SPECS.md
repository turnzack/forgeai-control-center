# UI SCREEN SPECIFICATIONS & AI GENERATION — Widget Pack

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Bibliothèque de Composants UI** dans Widget Pack.
...
```text
# STITCH PROMPT — Widget Pack

Contexte produit :
Widget Pack - Pack de widgets interactifs dans le domaine Bibliothèque de Composants UI.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Widget Pack.
