# UI SCREEN SPECIFICATIONS & AI GENERATION — AI Apps Pack

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Assistant IA & Chatbot** dans AI Apps Pack.
...
```text
# STITCH PROMPT — AI Apps Pack

Contexte produit :
AI Apps Pack - Pack PRD pour applications IA conversationnelles dans le domaine Assistant IA & Chatbot.
...
```text
Génère une illustration haute fidélité pour l'onboarding de AI Apps Pack.
