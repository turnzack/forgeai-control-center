# PROJECT BRIEF — AI Apps Pack

## 1. Nom du produit
**AI Apps Pack**

## 2. Résumé
Pack PRD pour applications IA conversationnelles. Solution métier dans le domaine **Assistant IA & Chatbot**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
