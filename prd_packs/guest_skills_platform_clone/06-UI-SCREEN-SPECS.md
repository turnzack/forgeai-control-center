# UI SCREEN SPECIFICATIONS & AI GENERATION — Skills Platform Clone

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **SaaS Dashboard & Analytics** dans Skills Platform Clone.
...
```text
# STITCH PROMPT — Skills Platform Clone

Contexte produit :
Skills Platform Clone - Clone de plateforme de skills à la Anthropic dans le domaine SaaS Dashboard & Analytics.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Skills Platform Clone.
