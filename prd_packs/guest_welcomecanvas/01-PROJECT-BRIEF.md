# PROJECT BRIEF — Welcome Canvas v2

## 1. Nom du produit
**Welcome Canvas v2**

## 2. Résumé
Canvas d'accueil version 2 avec animations. Solution métier dans le domaine **Landing Page & Conversion**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
