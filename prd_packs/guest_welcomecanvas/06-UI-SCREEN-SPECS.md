# UI SCREEN SPECIFICATIONS & AI GENERATION — Welcome Canvas v2

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Landing Page & Conversion** dans Welcome Canvas v2.
...
```text
# STITCH PROMPT — Welcome Canvas v2

Contexte produit :
Welcome Canvas v2 - Canvas d'accueil version 2 avec animations dans le domaine Landing Page & Conversion.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Welcome Canvas v2.
