# PROJECT BRIEF — SaaS Control

## 1. Nom du produit
**SaaS Control**

## 2. Résumé
Dashboard SaaS multi-tenant avec métriques temps réel. Solution métier dans le domaine **SaaS Dashboard & Analytics**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
