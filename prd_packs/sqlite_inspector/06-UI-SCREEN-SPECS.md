# UI SCREEN SPECIFICATIONS & AI GENERATION — SQLite Inspector

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **SaaS Dashboard & Analytics** dans SQLite Inspector.
...
```text
# STITCH PROMPT — SQLite Inspector

Contexte produit :
SQLite Inspector - Inspecteur visuel de bases SQLite dans le domaine SaaS Dashboard & Analytics.
...
```text
Génère une illustration haute fidélité pour l'onboarding de SQLite Inspector.
