# UI SCREEN SPECIFICATIONS & AI GENERATION — Fireguard AI

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **SaaS Dashboard & Analytics** dans Fireguard AI.
...
```text
# STITCH PROMPT — Fireguard AI

Contexte produit :
Fireguard AI - Surveillance de conformité sécurité par IA dans le domaine SaaS Dashboard & Analytics.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Fireguard AI.
