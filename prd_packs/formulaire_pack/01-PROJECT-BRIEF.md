# PROJECT BRIEF — Formulaire Pack

## 1. Nom du produit
**Formulaire Pack**

## 2. Résumé
Constructeur de formulaires multi-étapes. Solution métier dans le domaine **Formulaires & Sondages**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
