# PROJECT BRIEF — PDF & Docs Pack

## 1. Nom du produit
**PDF & Docs Pack**

## 2. Résumé
Générateur de documents PDF structurés. Solution métier dans le domaine **Documentation & PDF**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
