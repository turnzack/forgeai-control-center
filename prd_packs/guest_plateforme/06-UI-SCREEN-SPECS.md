# UI SCREEN SPECIFICATIONS & AI GENERATION — Plateforme Guest

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **SaaS Dashboard & Analytics** dans Plateforme Guest.
...
```text
# STITCH PROMPT — Plateforme Guest

Contexte produit :
Plateforme Guest - Plateforme multi-services invité dans le domaine SaaS Dashboard & Analytics.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Plateforme Guest.
