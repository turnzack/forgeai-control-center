# PROJECT BRIEF — Plateforme Guest

## 1. Nom du produit
**Plateforme Guest**

## 2. Résumé
Plateforme multi-services invité. Solution métier dans le domaine **SaaS Dashboard & Analytics**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
