# UI SCREEN SPECIFICATIONS & AI GENERATION — PaiementPro

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **E-commerce & Boutique en Ligne** dans PaiementPro.
...
```text
# STITCH PROMPT — PaiementPro

Contexte produit :
PaiementPro - Module de paiement multi-PSP (Stripe, PayPal, Mangopay) dans le domaine E-commerce & Boutique en Ligne.
...
```text
Génère une illustration haute fidélité pour l'onboarding de PaiementPro.
