# UI SCREEN SPECIFICATIONS & AI GENERATION — Checkout Express

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **E-commerce & Boutique en Ligne** dans Checkout Express.
...
```text
# STITCH PROMPT — Checkout Express

Contexte produit :
Checkout Express - Tunnel de checkout optimisé conversion dans le domaine E-commerce & Boutique en Ligne.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Checkout Express.
