# UI SCREEN SPECIFICATIONS & AI GENERATION — Design Showcase

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Portfolio Créatif & Showcase** dans Design Showcase.
...
```text
# STITCH PROMPT — Design Showcase

Contexte produit :
Design Showcase - Showcase de designs Figma/XD avec embeds dans le domaine Portfolio Créatif & Showcase.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Design Showcase.
