# UI SCREEN SPECIFICATIONS & AI GENERATION — Productivity Hub

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Gestion de Tâches & Kanban** dans Productivity Hub.
...
```text
# STITCH PROMPT — Productivity Hub

Contexte produit :
Productivity Hub - Hub de productivité personnelle (tasks + notes + habits) dans le domaine Gestion de Tâches & Kanban.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Productivity Hub.
