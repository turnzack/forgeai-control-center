# PROJECT BRIEF — Productivity Hub

## 1. Nom du produit
**Productivity Hub**

## 2. Résumé
Hub de productivité personnelle (tasks + notes + habits). Solution métier dans le domaine **Gestion de Tâches & Kanban**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
