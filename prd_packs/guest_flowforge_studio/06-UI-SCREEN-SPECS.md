# UI SCREEN SPECIFICATIONS & AI GENERATION — Flowforge Studio

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **SaaS Dashboard & Analytics** dans Flowforge Studio.
...
```text
# STITCH PROMPT — Flowforge Studio

Contexte produit :
Flowforge Studio - Studio visuel de construction de workflows dans le domaine SaaS Dashboard & Analytics.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Flowforge Studio.
