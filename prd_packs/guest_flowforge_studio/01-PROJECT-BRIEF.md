# PROJECT BRIEF — Flowforge Studio

## 1. Nom du produit
**Flowforge Studio**

## 2. Résumé
Studio visuel de construction de workflows. Solution métier dans le domaine **SaaS Dashboard & Analytics**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
