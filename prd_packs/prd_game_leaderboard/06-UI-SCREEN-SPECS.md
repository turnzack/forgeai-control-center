# UI SCREEN SPECIFICATIONS & AI GENERATION — Game Leaderboard

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Jeu Vidéo & Arcade** dans Game Leaderboard.
...
```text
# STITCH PROMPT — Game Leaderboard

Contexte produit :
Game Leaderboard - Leaderboard compétitif multi-jeux dans le domaine Jeu Vidéo & Arcade.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Game Leaderboard.
