# PROJECT BRIEF — Game Leaderboard

## 1. Nom du produit
**Game Leaderboard**

## 2. Résumé
Leaderboard compétitif multi-jeux. Solution métier dans le domaine **Jeu Vidéo & Arcade**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
