# UI SCREEN SPECIFICATIONS & AI GENERATION — E-Commerce Suite

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **E-commerce & Boutique en Ligne** dans E-Commerce Suite.
...
```text
# STITCH PROMPT — E-Commerce Suite

Contexte produit :
E-Commerce Suite - Suite e-commerce complète avec gestion stock dans le domaine E-commerce & Boutique en Ligne.
...
```text
Génère une illustration haute fidélité pour l'onboarding de E-Commerce Suite.
