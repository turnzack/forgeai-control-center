# PROJECT BRIEF — Game Launch Orchestrator

## 1. Nom du produit
**Game Launch Orchestrator**

## 2. Résumé
Orchestrateur de lancement de jeux. Solution métier dans le domaine **Jeu Vidéo & Arcade**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
