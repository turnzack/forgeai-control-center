# PROJECT BRIEF — PRD Generator

## 1. Nom du produit
**PRD Generator**

## 2. Résumé
Outil de génération de PRD assistée par IA. Solution métier dans le domaine **SaaS Dashboard & Analytics**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
