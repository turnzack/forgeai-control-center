# UI SCREEN SPECIFICATIONS & AI GENERATION — PRD Generator

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **SaaS Dashboard & Analytics** dans PRD Generator.
...
```text
# STITCH PROMPT — PRD Generator

Contexte produit :
PRD Generator - Outil de génération de PRD assistée par IA dans le domaine SaaS Dashboard & Analytics.
...
```text
Génère une illustration haute fidélité pour l'onboarding de PRD Generator.
