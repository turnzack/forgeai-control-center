# UI SCREEN SPECIFICATIONS & AI GENERATION — Plateforme v2

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **SaaS Dashboard & Analytics** dans Plateforme v2.
...
```text
# STITCH PROMPT — Plateforme v2

Contexte produit :
Plateforme v2 - Plateforme invité v2 avec workspaces dans le domaine SaaS Dashboard & Analytics.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Plateforme v2.
