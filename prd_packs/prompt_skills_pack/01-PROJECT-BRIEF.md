# PROJECT BRIEF — Prompt Skills

## 1. Nom du produit
**Prompt Skills**

## 2. Résumé
Bibliothèque de prompts et skills réutilisables. Solution métier dans le domaine **Assistant IA & Chatbot**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
