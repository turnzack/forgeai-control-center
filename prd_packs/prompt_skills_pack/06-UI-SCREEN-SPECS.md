# UI SCREEN SPECIFICATIONS & AI GENERATION — Prompt Skills

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Assistant IA & Chatbot** dans Prompt Skills.
...
```text
# STITCH PROMPT — Prompt Skills

Contexte produit :
Prompt Skills - Bibliothèque de prompts et skills réutilisables dans le domaine Assistant IA & Chatbot.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Prompt Skills.
