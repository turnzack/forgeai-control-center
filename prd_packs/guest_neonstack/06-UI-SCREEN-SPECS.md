# UI SCREEN SPECIFICATIONS & AI GENERATION — Neonstack

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **SaaS Dashboard & Analytics** dans Neonstack.
...
```text
# STITCH PROMPT — Neonstack

Contexte produit :
Neonstack - Stack néon-stack avec animations fluides dans le domaine SaaS Dashboard & Analytics.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Neonstack.
