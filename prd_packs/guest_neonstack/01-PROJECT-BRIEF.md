# PROJECT BRIEF — Neonstack

## 1. Nom du produit
**Neonstack**

## 2. Résumé
Stack néon-stack avec animations fluides. Solution métier dans le domaine **SaaS Dashboard & Analytics**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
