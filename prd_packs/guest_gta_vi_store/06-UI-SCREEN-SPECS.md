# UI SCREEN SPECIFICATIONS & AI GENERATION — GTA VI Merch Store

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **E-commerce & Boutique en Ligne** dans GTA VI Merch Store.
...
```text
# STITCH PROMPT — GTA VI Merch Store

Contexte produit :
GTA VI Merch Store - Boutique de produits dérivés gaming dans le domaine E-commerce & Boutique en Ligne.
...
```text
Génère une illustration haute fidélité pour l'onboarding de GTA VI Merch Store.
