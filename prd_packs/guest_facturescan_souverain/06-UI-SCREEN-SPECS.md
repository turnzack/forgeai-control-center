# UI SCREEN SPECIFICATIONS & AI GENERATION — FactureScan Souverain

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **SaaS Dashboard & Analytics** dans FactureScan Souverain.
...
```text
# STITCH PROMPT — FactureScan Souverain

Contexte produit :
FactureScan Souverain - OCR de factures avec extraction souveraine dans le domaine SaaS Dashboard & Analytics.
...
```text
Génère une illustration haute fidélité pour l'onboarding de FactureScan Souverain.
