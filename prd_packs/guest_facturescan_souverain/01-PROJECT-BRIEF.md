# PROJECT BRIEF — FactureScan Souverain

## 1. Nom du produit
**FactureScan Souverain**

## 2. Résumé
OCR de factures avec extraction souveraine. Solution métier dans le domaine **SaaS Dashboard & Analytics**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
