# UI SCREEN SPECIFICATIONS & AI GENERATION — Nebula Calc

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **SaaS Dashboard & Analytics** dans Nebula Calc.
...
```text
# STITCH PROMPT — Nebula Calc

Contexte produit :
Nebula Calc - Calculateur scientifique avancé pour le cloud dans le domaine SaaS Dashboard & Analytics.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Nebula Calc.
