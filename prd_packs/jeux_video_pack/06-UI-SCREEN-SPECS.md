# UI SCREEN SPECIFICATIONS & AI GENERATION — Jeux Vidéo Pack

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Jeu Vidéo & Arcade** dans Jeux Vidéo Pack.
...
```text
# STITCH PROMPT — Jeux Vidéo Pack

Contexte produit :
Jeux Vidéo Pack - Pack de mini-jeux web HTML5 dans le domaine Jeu Vidéo & Arcade.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Jeux Vidéo Pack.
