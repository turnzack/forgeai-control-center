# UI SCREEN SPECIFICATIONS & AI GENERATION — Cyberrunner

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Jeu Vidéo & Arcade** dans Cyberrunner.
...
```text
# STITCH PROMPT — Cyberrunner

Contexte produit :
Cyberrunner - Runner cyberpunk avec obstacles procéduraux dans le domaine Jeu Vidéo & Arcade.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Cyberrunner.
