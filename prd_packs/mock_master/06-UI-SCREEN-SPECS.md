# UI SCREEN SPECIFICATIONS & AI GENERATION — Mock Master

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **SaaS Dashboard & Analytics** dans Mock Master.
...
```text
# STITCH PROMPT — Mock Master

Contexte produit :
Mock Master - Générateur de mocks d'API pour tests E2E dans le domaine SaaS Dashboard & Analytics.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Mock Master.
