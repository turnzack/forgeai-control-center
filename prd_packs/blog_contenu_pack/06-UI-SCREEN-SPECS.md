# UI SCREEN SPECIFICATIONS & AI GENERATION — ContenuPro

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Blog & Contenu Éditorial** dans ContenuPro.
...
```text
# STITCH PROMPT — ContenuPro

Contexte produit :
ContenuPro - Plateforme de blog éditorial SEO-first dans le domaine Blog & Contenu Éditorial.
...
```text
Génère une illustration haute fidélité pour l'onboarding de ContenuPro.
