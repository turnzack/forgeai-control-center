# PROJECT BRIEF — ContenuPro

## 1. Nom du produit
**ContenuPro**

## 2. Résumé
Plateforme de blog éditorial SEO-first. Solution métier dans le domaine **Blog & Contenu Éditorial**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
