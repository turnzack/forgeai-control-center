# PROJECT BRIEF — Tetris Evolution

## 1. Nom du produit
**Tetris Evolution**

## 2. Résumé
Tetris évolutif avec power-ups et niveaux. Solution métier dans le domaine **Jeu Vidéo & Arcade**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
