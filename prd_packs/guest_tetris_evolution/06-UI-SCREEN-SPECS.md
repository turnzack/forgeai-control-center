# UI SCREEN SPECIFICATIONS & AI GENERATION — Tetris Evolution

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Jeu Vidéo & Arcade** dans Tetris Evolution.
...
```text
# STITCH PROMPT — Tetris Evolution

Contexte produit :
Tetris Evolution - Tetris évolutif avec power-ups et niveaux dans le domaine Jeu Vidéo & Arcade.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Tetris Evolution.
