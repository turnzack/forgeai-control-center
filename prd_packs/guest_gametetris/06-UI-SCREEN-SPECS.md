# UI SCREEN SPECIFICATIONS & AI GENERATION — Game Tetris

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Jeu Vidéo & Arcade** dans Game Tetris.
...
```text
# STITCH PROMPT — Game Tetris

Contexte produit :
Game Tetris - Tetris classique avec leaderboard dans le domaine Jeu Vidéo & Arcade.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Game Tetris.
