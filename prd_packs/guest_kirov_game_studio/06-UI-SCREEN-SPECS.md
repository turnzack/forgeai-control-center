# UI SCREEN SPECIFICATIONS & AI GENERATION — Kirov Game Studio

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Jeu Vidéo & Arcade** dans Kirov Game Studio.
...
```text
# STITCH PROMPT — Kirov Game Studio

Contexte produit :
Kirov Game Studio - Studio de création de jeux web dans le domaine Jeu Vidéo & Arcade.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Kirov Game Studio.
