# UI SCREEN SPECIFICATIONS & AI GENERATION — AI Voice Agent

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Assistant IA & Chatbot** dans AI Voice Agent.
...
```text
# STITCH PROMPT — AI Voice Agent

Contexte produit :
AI Voice Agent - Agent vocal IA pour support client dans le domaine Assistant IA & Chatbot.
...
```text
Génère une illustration haute fidélité pour l'onboarding de AI Voice Agent.
