# PROJECT BRIEF — AI Voice Agent

## 1. Nom du produit
**AI Voice Agent**

## 2. Résumé
Agent vocal IA pour support client. Solution métier dans le domaine **Assistant IA & Chatbot**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
