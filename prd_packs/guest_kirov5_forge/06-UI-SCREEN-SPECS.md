# UI SCREEN SPECIFICATIONS & AI GENERATION — Kirov5 Forge

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **SaaS Dashboard & Analytics** dans Kirov5 Forge.
...
```text
# STITCH PROMPT — Kirov5 Forge

Contexte produit :
Kirov5 Forge - Forge industrielle de génération de code dans le domaine SaaS Dashboard & Analytics.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Kirov5 Forge.
