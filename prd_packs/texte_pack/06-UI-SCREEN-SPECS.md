# UI SCREEN SPECIFICATIONS & AI GENERATION — Texte Editor

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Blog & Contenu Éditorial** dans Texte Editor.
...
```text
# STITCH PROMPT — Texte Editor

Contexte produit :
Texte Editor - Éditeur de texte long-format avec focus mode dans le domaine Blog & Contenu Éditorial.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Texte Editor.
