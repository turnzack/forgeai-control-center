# PROJECT BRIEF — Texte Editor

## 1. Nom du produit
**Texte Editor**

## 2. Résumé
Éditeur de texte long-format avec focus mode. Solution métier dans le domaine **Blog & Contenu Éditorial**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
