# UI SCREEN SPECIFICATIONS & AI GENERATION — PRD Guest

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **SaaS Dashboard & Analytics** dans PRD Guest.
...
```text
# STITCH PROMPT — PRD Guest

Contexte produit :
PRD Guest - Pack PRD générique en mode invité dans le domaine SaaS Dashboard & Analytics.
...
```text
Génère une illustration haute fidélité pour l'onboarding de PRD Guest.
