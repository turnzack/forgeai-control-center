# PROJECT BRIEF — App Web Studio

## 1. Nom du produit
**App Web Studio**

## 2. Résumé
Studio de construction d'applications web. Solution métier dans le domaine **SaaS Dashboard & Analytics**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
