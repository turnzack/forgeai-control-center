# UI SCREEN SPECIFICATIONS & AI GENERATION — Adaptive Landing

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Landing Page & Conversion** dans Adaptive Landing.
...
```text
# STITCH PROMPT — Adaptive Landing

Contexte produit :
Adaptive Landing - Landing page adaptive au contexte visiteur dans le domaine Landing Page & Conversion.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Adaptive Landing.
