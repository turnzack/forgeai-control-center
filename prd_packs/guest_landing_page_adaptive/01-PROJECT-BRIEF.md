# PROJECT BRIEF — Adaptive Landing

## 1. Nom du produit
**Adaptive Landing**

## 2. Résumé
Landing page adaptive au contexte visiteur. Solution métier dans le domaine **Landing Page & Conversion**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
