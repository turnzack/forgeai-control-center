# UI SCREEN SPECIFICATIONS & AI GENERATION — Universal Scraper

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Web Scraping & Extraction de Données** dans Universal Scraper.
...
```text
# STITCH PROMPT — Universal Scraper

Contexte produit :
Universal Scraper - Scraper universel configurable par selectors dans le domaine Web Scraping & Extraction de Données.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Universal Scraper.
