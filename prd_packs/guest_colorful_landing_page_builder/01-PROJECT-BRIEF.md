# PROJECT BRIEF — Colorful LP Builder

## 1. Nom du produit
**Colorful LP Builder**

## 2. Résumé
Builder de landing pages colorées no-code. Solution métier dans le domaine **Landing Page & Conversion**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
