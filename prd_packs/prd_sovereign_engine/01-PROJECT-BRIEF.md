# PROJECT BRIEF — Sovereign Engine

## 1. Nom du produit
**Sovereign Engine**

## 2. Résumé
Moteur souverain d'orchestration IA on-premise. Solution métier dans le domaine **SaaS Dashboard & Analytics**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
