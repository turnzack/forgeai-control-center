# UI SCREEN SPECIFICATIONS & AI GENERATION — Vercel UI

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Bibliothèque de Composants UI** dans Vercel UI.
...
```text
# STITCH PROMPT — Vercel UI

Contexte produit :
Vercel UI - Système UI inspiré Vercel (sobre, noir/blanc) dans le domaine Bibliothèque de Composants UI.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Vercel UI.
