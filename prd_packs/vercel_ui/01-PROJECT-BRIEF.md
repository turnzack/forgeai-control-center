# PROJECT BRIEF — Vercel UI

## 1. Nom du produit
**Vercel UI**

## 2. Résumé
Système UI inspiré Vercel (sobre, noir/blanc). Solution métier dans le domaine **Bibliothèque de Composants UI**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
