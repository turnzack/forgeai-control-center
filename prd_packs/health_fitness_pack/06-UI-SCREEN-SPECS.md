# UI SCREEN SPECIFICATIONS & AI GENERATION — Health & Fitness

## 1. Spécification Écran SCR-001 : /onboarding
- **Route** : `/onboarding`
- **Objectif** : écran central pour l'expérience **Application Mobile & PWA** dans Health & Fitness.
...
```text
# STITCH PROMPT — Health & Fitness

Contexte produit :
Health & Fitness - App de suivi fitness et santé dans le domaine Application Mobile & PWA.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Health & Fitness.
