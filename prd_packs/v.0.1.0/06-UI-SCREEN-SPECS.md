# UI SCREEN SPECIFICATIONS & AI GENERATION — Version Zero

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **SaaS Dashboard & Analytics** dans Version Zero.
...
```text
# STITCH PROMPT — Version Zero

Contexte produit :
Version Zero - Pack PRD v0.1.0 stable dans le domaine SaaS Dashboard & Analytics.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Version Zero.
