# UI SCREEN SPECIFICATIONS & AI GENERATION — Mariob Quest

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Jeu Vidéo & Arcade** dans Mariob Quest.
...
```text
# STITCH PROMPT — Mariob Quest

Contexte produit :
Mariob Quest - Quest plateforme inspirée Mario dans le domaine Jeu Vidéo & Arcade.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Mariob Quest.
