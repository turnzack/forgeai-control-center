# PROJECT BRIEF — Créateur Portfolio

## 1. Nom du produit
**Créateur Portfolio**

## 2. Résumé
Portfolio pour créatifs indépendants. Solution métier dans le domaine **Portfolio Créatif & Showcase**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
