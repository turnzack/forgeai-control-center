# UI SCREEN SPECIFICATIONS & AI GENERATION — Stitchlab

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **SaaS Dashboard & Analytics** dans Stitchlab.
...
```text
# STITCH PROMPT — Stitchlab

Contexte produit :
Stitchlab - Laboratoire de génération d'UI via Google Stitch dans le domaine SaaS Dashboard & Analytics.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Stitchlab.
