# UI SCREEN SPECIFICATIONS & AI GENERATION — Welcome Vibes

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Landing Page & Conversion** dans Welcome Vibes.
...
```text
# STITCH PROMPT — Welcome Vibes

Contexte produit :
Welcome Vibes - Landing vibes avec esthétique Gen-Z dans le domaine Landing Page & Conversion.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Welcome Vibes.
