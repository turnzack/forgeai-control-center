# UI SCREEN SPECIFICATIONS & AI GENERATION — ChatCom

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Chat & Messagerie Temps Réel** dans ChatCom.
...
```text
# STITCH PROMPT — ChatCom

Contexte produit :
ChatCom - Messenger temps réel avec appels audio dans le domaine Chat & Messagerie Temps Réel.
...
```text
Génère une illustration haute fidélité pour l'onboarding de ChatCom.
