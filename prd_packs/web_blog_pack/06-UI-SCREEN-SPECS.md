# UI SCREEN SPECIFICATIONS & AI GENERATION — Web Blog Engine

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Blog & Contenu Éditorial** dans Web Blog Engine.
...
```text
# STITCH PROMPT — Web Blog Engine

Contexte produit :
Web Blog Engine - CMS de blog minimaliste pour développeurs dans le domaine Blog & Contenu Éditorial.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Web Blog Engine.
