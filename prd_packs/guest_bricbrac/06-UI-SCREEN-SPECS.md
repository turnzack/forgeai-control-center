# UI SCREEN SPECIFICATIONS & AI GENERATION — Bric-à-brac Marketplace

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **E-commerce & Boutique en Ligne** dans Bric-à-brac Marketplace.
...
```text
# STITCH PROMPT — Bric-à-brac Marketplace

Contexte produit :
Bric-à-brac Marketplace - Marketplace de seconde main entre particuliers dans le domaine E-commerce & Boutique en Ligne.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Bric-à-brac Marketplace.
