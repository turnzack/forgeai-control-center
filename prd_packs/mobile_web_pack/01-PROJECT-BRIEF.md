# PROJECT BRIEF — Mobile Web

## 1. Nom du produit
**Mobile Web**

## 2. Résumé
App web mobile responsive optimisée. Solution métier dans le domaine **Application Mobile & PWA**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
