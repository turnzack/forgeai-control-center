# UI SCREEN SPECIFICATIONS & AI GENERATION — Mobile Web

## 1. Spécification Écran SCR-001 : /onboarding
- **Route** : `/onboarding`
- **Objectif** : écran central pour l'expérience **Application Mobile & PWA** dans Mobile Web.
...
```text
# STITCH PROMPT — Mobile Web

Contexte produit :
Mobile Web - App web mobile responsive optimisée dans le domaine Application Mobile & PWA.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Mobile Web.
