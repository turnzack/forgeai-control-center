# UI SCREEN SPECIFICATIONS & AI GENERATION — Produit Showcase

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **E-commerce & Boutique en Ligne** dans Produit Showcase.
...
```text
# STITCH PROMPT — Produit Showcase

Contexte produit :
Produit Showcase - Vitrine produit marketing avec comparateur dans le domaine E-commerce & Boutique en Ligne.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Produit Showcase.
