# UI SCREEN SPECIFICATIONS & AI GENERATION — Workflow Automation Studio

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **SaaS Dashboard & Analytics** dans Workflow Automation Studio.
...
```text
# STITCH PROMPT — Workflow Automation Studio

Contexte produit :
Workflow Automation Studio - Studio de design d'automatisations dans le domaine SaaS Dashboard & Analytics.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Workflow Automation Studio.
