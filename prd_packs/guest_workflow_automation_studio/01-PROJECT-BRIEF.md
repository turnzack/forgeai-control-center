# PROJECT BRIEF — Workflow Automation Studio

## 1. Nom du produit
**Workflow Automation Studio**

## 2. Résumé
Studio de design d'automatisations. Solution métier dans le domaine **SaaS Dashboard & Analytics**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
