# UI SCREEN SPECIFICATIONS & AI GENERATION — Billing Pro

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **SaaS Dashboard & Analytics** dans Billing Pro.
...
```text
# STITCH PROMPT — Billing Pro

Contexte produit :
Billing Pro - Module de facturation SaaS avancé dans le domaine SaaS Dashboard & Analytics.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Billing Pro.
