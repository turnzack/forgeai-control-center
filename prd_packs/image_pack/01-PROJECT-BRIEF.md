# PROJECT BRIEF — Image Pack

## 1. Nom du produit
**Image Pack**

## 2. Résumé
Galerie d'images avec lightbox. Solution métier dans le domaine **Bibliothèque de Composants UI**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
