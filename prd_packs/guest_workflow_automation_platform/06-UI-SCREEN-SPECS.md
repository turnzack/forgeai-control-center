# UI SCREEN SPECIFICATIONS & AI GENERATION — Workflow Automation Platform

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **SaaS Dashboard & Analytics** dans Workflow Automation Platform.
...
```text
# STITCH PROMPT — Workflow Automation Platform

Contexte produit :
Workflow Automation Platform - Plateforme d'automatisation no-code dans le domaine SaaS Dashboard & Analytics.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Workflow Automation Platform.
