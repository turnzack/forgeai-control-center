# PROJECT BRIEF — Workflow Automation Platform

## 1. Nom du produit
**Workflow Automation Platform**

## 2. Résumé
Plateforme d'automatisation no-code. Solution métier dans le domaine **SaaS Dashboard & Analytics**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
