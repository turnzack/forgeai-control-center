# UI SCREEN SPECIFICATIONS & AI GENERATION — Preorder Manager

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **E-commerce & Boutique en Ligne** dans Preorder Manager.
...
```text
# STITCH PROMPT — Preorder Manager

Contexte produit :
Preorder Manager - Gestion des précommandes et file d'attente dans le domaine E-commerce & Boutique en Ligne.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Preorder Manager.
