# UI SCREEN SPECIFICATIONS & AI GENERATION — Spécialisé Pack

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **SaaS Dashboard & Analytics** dans Spécialisé Pack.
...
```text
# STITCH PROMPT — Spécialisé Pack

Contexte produit :
Spécialisé Pack - Pack PRD pour métiers spécialisés dans le domaine SaaS Dashboard & Analytics.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Spécialisé Pack.
