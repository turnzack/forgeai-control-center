# UI SCREEN SPECIFICATIONS & AI GENERATION — Pièces Jointes Pack

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Formulaires & Sondages** dans Pièces Jointes Pack.
...
```text
# STITCH PROMPT — Pièces Jointes Pack

Contexte produit :
Pièces Jointes Pack - Module d'upload de pièces jointes dans le domaine Formulaires & Sondages.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Pièces Jointes Pack.
