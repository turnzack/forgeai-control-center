# PROJECT BRIEF — Pièces Jointes Pack

## 1. Nom du produit
**Pièces Jointes Pack**

## 2. Résumé
Module d'upload de pièces jointes. Solution métier dans le domaine **Formulaires & Sondages**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
