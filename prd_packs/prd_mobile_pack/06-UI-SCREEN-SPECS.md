# UI SCREEN SPECIFICATIONS & AI GENERATION — PRD Mobile Pack

## 1. Spécification Écran SCR-001 : /onboarding
- **Route** : `/onboarding`
- **Objectif** : écran central pour l'expérience **Application Mobile & PWA** dans PRD Mobile Pack.
...
```text
# STITCH PROMPT — PRD Mobile Pack

Contexte produit :
PRD Mobile Pack - Pack PRD pour apps mobiles natives dans le domaine Application Mobile & PWA.
...
```text
Génère une illustration haute fidélité pour l'onboarding de PRD Mobile Pack.
