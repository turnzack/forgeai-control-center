# UI SCREEN SPECIFICATIONS & AI GENERATION — Landing Forge

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Landing Page & Conversion** dans Landing Forge.
...
```text
# STITCH PROMPT — Landing Forge

Contexte produit :
Landing Forge - Générateur de landing pages haute conversion dans le domaine Landing Page & Conversion.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Landing Forge.
