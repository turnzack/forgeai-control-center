# UI SCREEN SPECIFICATIONS & AI GENERATION — Bros Platformer

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Jeu Vidéo & Arcade** dans Bros Platformer.
...
```text
# STITCH PROMPT — Bros Platformer

Contexte produit :
Bros Platformer - Platformer 2D type Mario Bros dans le domaine Jeu Vidéo & Arcade.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Bros Platformer.
