# PROJECT BRIEF — Chat Comms Pack

## 1. Nom du produit
**Chat Comms Pack**

## 2. Résumé
Pack de chat d'équipe avec canaux et DM. Solution métier dans le domaine **Chat & Messagerie Temps Réel**, conçue pour délivrer une expérience authentique et spécialisée — pas un template générique — avec une architecture moderne (React 18+, TypeScript strict, Tailwind), une persistance D1/SQLite et une UI soignée.
