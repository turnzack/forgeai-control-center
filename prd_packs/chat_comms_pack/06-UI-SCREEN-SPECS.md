# UI SCREEN SPECIFICATIONS & AI GENERATION — Chat Comms Pack

## 1. Spécification Écran SCR-001 : /
- **Route** : `/`
- **Objectif** : écran central pour l'expérience **Chat & Messagerie Temps Réel** dans Chat Comms Pack.
...
```text
# STITCH PROMPT — Chat Comms Pack

Contexte produit :
Chat Comms Pack - Pack de chat d'équipe avec canaux et DM dans le domaine Chat & Messagerie Temps Réel.
...
```text
Génère une illustration haute fidélité pour l'onboarding de Chat Comms Pack.
