...
Le Bridge protège les chemins contre `..`, crée les sous-dossiers et force le port `5174` pour les commandes `dev`. Le cockpit propose aussi le sélecteur de dossier du navigateur si le Bridge n’est pas lancé.
